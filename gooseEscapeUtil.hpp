...
const int NUM_BOARD_Y = 24;  // needs to be < NUM_SCREEN_Y
...
const int NUM_CONSOLE_X = 79;  //Changed this and the one on the next line
const int NUM_CONSOLE_Y = 24;  //so that we have a unique instruction screen
const int MIN_CONSOLE_X = 1;
const int MIN_CONSOLE_Y = 1;
